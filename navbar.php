  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav-underline">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="company1_controller.php">Магазины company1</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link " href="company2_controller.php">Магазины company2</a>
                    </li>
                    <li class="nav-item">
                ...
                <form class='px-2' action='msg.php' method='post'>
                ...
                <span class="navbar-text ">
                    <? if (isset($_SESSION['login'])) {
                        echo "      
                <form class='px-2' action='logout.php' method='post'>
                    <button class='btn btn-sm btn-outline-secondary' type='submit'>Выйти</button>
                </form>";
                    } else {
                        echo "      
                    <form class='px-2' action='login.php' method='post'>
                ...
                <button id="themeSwitcher" class="px-2 mx-2 btn btn-sm btn-outline-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-brightness-alt-high" viewBox="0 0 16 16">
